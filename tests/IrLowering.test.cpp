...
bb_bytecode_1:
  ...
  %30 = LOAD_POINTER R0
  %32 = TRUNCATE_UINT %18
  CHECK_BUFFER_LEN %30, %32, 0i, 4i, undef, exit(9)
  %34 = BUFFER_READI32 %30, %32
  %42 = ADD_NUM %21, 4
  %52 = NUM_TO_INT %42
  CHECK_BUFFER_LEN %30, %52, 0i, 4i, undef, exit(17)
  %54 = BUFFER_READI32 %30, %52
  %65 = BITAND_UINT %34, 4194303i
  %76 = BITAND_UINT %54, 4194303i
  %86 = BITRSHIFT_UINT %34, 22i
  %96 = BITRSHIFT_UINT %54, 22i
  %131 = BITAND_UINT %86, -1047553i
  %132 = BITAND_UINT %96, 1023i
  %133 = BITLSHIFT_UINT %132, 10i
  %134 = BITOR_UINT %131, %133
  %149 = UINT_TO_FLOAT %65
  %150 = UINT_TO_FLOAT %76
  %151 = UINT_TO_FLOAT %134
  %157 = LOAD_DOUBLE R1
  %158 = ADD_NUM %157, 16
  %165 = NUM_TO_UINT %158
  %168 = UINT_TO_NUM %165
  %175 = FLOAT_TO_NUM %149
  %181 = FLOAT_TO_NUM %150
  %187 = FLOAT_TO_NUM %151
  %194 = NUM_TO_UINT %175
  %196 = BITAND_UINT %194, 4194303i
  %218 = NUM_TO_UINT %187
  %233 = BITAND_UINT %196, 4194303i
  %234 = BITAND_UINT %218, 1023i
  %235 = BITLSHIFT_UINT %234, 22i
  %236 = BITOR_UINT %233, %235
  %247 = NUM_TO_UINT %181
  %249 = BITAND_UINT %247, 4194303i
  %259 = BITRSHIFT_UINT %218, 10i
  %294 = BITAND_UINT %249, 4194303i
  %295 = BITAND_UINT %259, 1023i
  %296 = BITLSHIFT_UINT %295, 22i
  %297 = BITOR_UINT %294, %296
  %311 = TRUNCATE_UINT %165
  CHECK_BUFFER_LEN %30, %311, 0i, 4i, undef, exit(113)
  BUFFER_WRITEI32 %30, %311, %236
  %320 = ADD_NUM %168, 4
  %332 = NUM_TO_INT %320
  CHECK_BUFFER_LEN %30, %332, 0i, 4i, undef, exit(122)
  BUFFER_WRITEI32 %30, %332, %297
  INTERRUPT 127u
  RETURN R0, 0i
)"
);
