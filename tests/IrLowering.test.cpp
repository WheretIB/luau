...
static std::string getCodegenAssembly(const char* source, bool includeIrTypes = false, int debugLevel = 1, int optimizationLevel = 2, bool clipToFirstReturn = false)
{
...
bb_bytecode_0:
  ...
  %295 = NUM_TO_UINT %288
  %298 = UINT_TO_NUM %295
  STORE_SPLIT_TVALUE R19, tnumber, %298
